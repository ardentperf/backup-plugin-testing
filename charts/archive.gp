...
set output "/home/ubuntu/projects/backups/charts/wal-archive-rate.png"
set title "WAL Archive Rate by Plugin, Instance, and Thread Count" font "Sans,13"
set ylabel "MB/min archived to S3"
set xlabel "WAL threads"
...
set yrange [0:*]
set yrange [0:24220.0]
set xtics rotate by -30
set xtics ("1 threads" 0, "8 threads" 1, "16 threads" 2, "24 threads" 3, "32 threads" 4)
set arrow from graph 0,first 25324.875 to graph 1,first 25324.875 nohead lc rgb "#cc0000" lw 2 dt 2 front
set label "avg WAL gen (25325 MB/min)" at graph 0.01, first 25324.875 offset 0,0.5 tc rgb "#cc0000" font "Sans,9"
plot "/home/ubuntu/projects/backups/charts/archive.dat" using 2:xtic(1) title "barman / ip-192-168-16-108" lc rgb "#7eb9e8", \
