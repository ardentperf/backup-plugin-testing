...
set output "/home/ubuntu/projects/backups/charts/t9-32g-backup.png"
set title "32GB Backup Rate by Plugin, Instance, and Jobs" font "Sans,13"
set ylabel "MB/min"
...
plot "/home/ubuntu/projects/backups/charts/t9_32g_backup.dat" using 2:xtic(1) title "barman / ip-192-168-19-208" lc rgb "#1a6aab", \
